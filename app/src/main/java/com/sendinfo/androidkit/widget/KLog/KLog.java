...
public class KLog implements Constant
{
	...
	private static String TAG = "Sendinfo";
	...
	public static void jsondata(String jsonFormat)
	{
		printLog(JSONDATA, null, jsonFormat);
	}

	public static void jsondata(String tag, String jsonFormat)
	{
		printLog(JSONDATA, tag, jsonFormat);
	}
	...
	private static void printLog(int type, String tagStr, Object objectMsg, Object... args)
	{
		...
		switch (type)
		{
			...
			case JSON:
				...
				break;
			case JSONDATA:
				JsonDataLog.printJson(tag, msg, headString);
				break;
			case XML:
