package com.sendinfo.androidkit.widget.welcomPage;
...
import com.sendinfo.androidkit.module.other.ui.WelcomActivity;
...
public class PageFrameLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setUpViews(int layoutIds[], int dot_on, int dot_off) {
        ...
        setSelectVp(0);
        WelcomActivity activity = (WelcomActivity) getContext();
